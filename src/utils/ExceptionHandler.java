...
public class ExceptionHandler extends RuntimeException {
    ...
    protected final void showMsg(final String msg, final boolean quit) {
        ...
        f.pack();
        f.setSize(400, 250);
        f.setMinimumSize(new Dimension(400, 250));
     ...
     * @param cause la cause de l'exception (peut ̻tre <code>null</code>).
     */
    ...
    /**
     * Affiche l'erreur et quitte suivant l'option pass̩e.
     * 
     * @param comp the component upon which to display the popup.
