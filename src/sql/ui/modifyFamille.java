 ...
 * @author Oussama
 */
public final class modifyFamille extends JPanel {

    private JFrame parent;
    private String modify;
    private ComboBoxFamille comboBox;

    public modifyFamille(final JFrame parent, String modify) throws HeadlessException, IOException {
        this.modify = modify;
        this.addViews();
    ...
    public void addViews() throws HeadlessException, IOException {
        ...
        // Titre
        final JLabel title = new JLabel("Modifier une famille", SwingConstants.CENTER);
        ...
        final JTextField textNom = new JTextField(modify);
        textNom.setText(modify);
        ...
        okButton.addActionListener(new java.awt.event.ActionListener() {
            ...
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ...
                if (!textNom.getText().trim().isEmpty()) {
                    ...
                    query.setString("name", modify);
                    int rowCount = query.executeUpdate();
                    if (rowCount != 0) {
                        String show = "la Famille " + modify + " a bien été modifé";
                        d.showMessageDialog(new JFrame(), show, "Modification", JOptionPane.INFORMATION_MESSAGE);
                        try {
                            articlePan.update();
